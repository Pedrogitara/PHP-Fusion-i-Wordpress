...
if (iMEMBER) {
    ...
    if ($userdata['user_avatar'] && file_exists(IMAGES . "avatars/{$userdata['user_avatar']}")) {
        echo "<center><img src='" . IMAGES . "avatars/{$userdata['user_avatar']}' alt='' /></center><br /><br />\n";
    }
    ...
    if (!preg_match('/login.php/i', FUSION_SELF)) {
        ...
        echo "<input type='submit' name='login' value='" . $locale['global_104'] .
            "' class='button' /><br />\n";
        echo "</form>\n<br />\n\n";
        echo "<center><a href='".INFUSIONS."connect/'><img src='".INFUSIONS."connect/images/fb_login.png' alt='' /></a></center><br />";
